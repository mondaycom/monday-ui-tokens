 ...
 *
 * Replaces [default] with 'default', or any keyword included in the pathOperators object
 *
 * Primarily used for values interacted with via typescript and css-in-js
 *
...
const normalizeTokenPath = (object) => {
  // set a list of operators to replace reserved words with
  const pathOperators = {
    "[default]": "default",
  };
  ...
  return Array.isArray(object)
    ...
    : // check if the value of a key is an object
